...
- Custos authorization kernel and secured-runtime primitives:
  - `Permissions`
  - `RoleKey`
  - `Role`
  - `PermissionGrant`
...
### Deferred Custos Work

- Permission-management services, direct actor grants, and structured authorization traces.
- Collection-read filtering, alias-to-`SiteKey` authorization, and permission vocabulary for
  item delete/restore and site unarchive.
...
1. `README.md`
2. `docs/architecture/CODEX-BLUEPRINT.md`
...
6. `docs/roadmap/future/custos-domain-authorization-model.md`
7. `docs/adr/ADR-011-observance-metrics-foundation.md`
