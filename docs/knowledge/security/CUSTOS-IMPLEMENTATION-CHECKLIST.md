...
- [x] Phase 3 secured service decorators complete.
- [ ] Phase 4 not started.
...
- [ ] `RoleAssignmentPermissionsService` — not implemented; privilege-management operations remain deferred.
...
- Which pending authorization follow-up should come first: direct grants, explanation trace, or
