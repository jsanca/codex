...
A fatal Custos invariant violation during delete propagates and is not converted to denial.

## Source Use Case

Use Case 02 — ContentItem Delete Under Secured Runtime (Alternate Flow — Hard Invariant
Violation).
...
- The ContentItem continues to exist unchanged.
