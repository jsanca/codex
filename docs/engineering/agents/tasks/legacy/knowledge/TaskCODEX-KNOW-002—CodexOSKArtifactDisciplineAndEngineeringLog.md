...
* `docs/engineering/agents/templates/implementation-report-template.md`
* `docs/engineering/agents/templates/review-report-template.md`
* `docs/engineering/agents/templates/recovery-checkpoint-template.md`
...
* `docs/engineering/agents/templates/`

Existing historical structure includes:

* `docs/engineering/agents/tasks/custos/`
* `docs/engineering/agents/tasks/knowledge/`
* `docs/engineering/agents/tasks/reviewer/`
* `docs/engineering/agents/tasks/transversal/`
* `docs/engineering/agents/reviewer/` singular historical directory
...
```text
docs/engineering/agents/reviewer/
```
...
* `docs/engineering/ENGINEERING_LOG.md`
* Optional `docs/engineering/agents/README.md`
