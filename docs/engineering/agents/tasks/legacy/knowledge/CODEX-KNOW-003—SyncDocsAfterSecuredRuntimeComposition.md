...
* `docs/engineering/agents/checkpoints/` if a new checkpoint or checkpoint update is appropriate
* `docs/engineering/agents/README.md` only if runtime artifact discipline needs a small clarification
...
* short report under `docs/engineering/agents/reports/knowledge/`
