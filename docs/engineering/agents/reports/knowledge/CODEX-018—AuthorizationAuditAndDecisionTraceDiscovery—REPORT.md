...
* `docs/engineering/agents/tasks/legacy/knowledge/TaskCODEX-018—AuthorizationAuditAndDecisionTraceDiscovery.md`
...
```bash
git diff --check -- docs/engineering/agents/reports/knowledge/CODEX-018—AuthorizationAuditAndDecisionTraceDiscovery—REPORT.md
```
