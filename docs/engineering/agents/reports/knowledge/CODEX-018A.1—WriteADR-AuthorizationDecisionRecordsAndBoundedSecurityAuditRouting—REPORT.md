...
* `docs/engineering/agents/reports/knowledge/CODEX-018A.1—WriteADR-AuthorizationDecisionRecordsAndBoundedSecurityAuditRouting—REPORT.md`
...
`docs/roadmap/future/custos-permission-decision-caching.md` already exists, but it is in a separate future-forward corpus. The new ADR uses `ADR-012.md` inside `docs/ADR-corpus/`, following that folder's local numbering.

## Sources Reviewed

* `docs/engineering/agents/tasks/legacy/knowledge/TaskCODEX-018A.1—WriteADR:AuthorizationDecisionRecordsAndBoundedSecurityAuditRouting.md`
...
* `docs/engineering/agents/reports/knowledge/CODEX-018—AuthorizationAuditAndDecisionTraceDiscovery—REPORT.md`
* `docs/security/CUSTOS-MODEL.md`
* `docs/adr/ADR-010-chronicon-audit-coverage.md`
* `docs/adr/ADR-011-observance-metrics-foundation.md`
* `docs/roadmap/future/custos-permission-decision-caching.md`
