...
/**
 * Tests for {@link ContentItemRestoredChroniconSubscriber}.
 */
class ContentItemRestoredChroniconSubscriberTest {
    ...
    private ContentItemRestoredChroniconSubscriber subscriber;
    private ContentItemRestoredEvent event;

    @BeforeEach
    void setUp() {
        repository = new RecordingChroniconRepository();
        subscriber = new ContentItemRestoredChroniconSubscriber(repository);
        event = new ContentItemRestoredEvent(ITEM_ID, SITE_KEY, CT_KEY, CT_VERSION_ID, ITEM_KEY, ACTOR, NOW);
    }

    @Test
    void rejectsNullRepository() {
        assertThrows(NullPointerException.class, () -> new ContentItemRestoredChroniconSubscriber(null));
    }

    @Test
    void eventTypeIsContentItemRestoredEvent() {
