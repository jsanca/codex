...
/**
 * Tests for {@link ContentItemDeletedCacheInvalidationSubscriber}.
 */
class ContentItemDeletedCacheInvalidationSubscriberTest {
    ...
    private ContentItemDeletedCacheInvalidationSubscriber subscriber;

    @BeforeEach
    void setUp() {
        cache = new ConcurrentMapCacheRegion<>();
        subscriber = new ContentItemDeletedCacheInvalidationSubscriber(cache);
    }
    ...
    void constructorRejectsNullCache() {
        assertThrows(NullPointerException.class,
                () -> new ContentItemDeletedCacheInvalidationSubscriber(null));
    }

    // --- eventType ---

    @Test
    void eventTypeReturnsContentItemDeletedEventClass() {
    ...
    private static ContentItemDeletedEvent buildEvent() {
        return new ContentItemDeletedEvent(
