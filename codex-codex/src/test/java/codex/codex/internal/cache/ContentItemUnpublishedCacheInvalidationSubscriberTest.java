...
/**
 * Tests for {@link ContentItemUnpublishedCacheInvalidationSubscriber}.
 */
class ContentItemUnpublishedCacheInvalidationSubscriberTest {
    ...
    private ContentItemUnpublishedCacheInvalidationSubscriber subscriber;

    @BeforeEach
    void setUp() {
        cache = new ConcurrentMapCacheRegion<>();
        subscriber = new ContentItemUnpublishedCacheInvalidationSubscriber(cache);
    }
    ...
    void constructorRejectsNullCache() {
        assertThrows(NullPointerException.class,
                () -> new ContentItemUnpublishedCacheInvalidationSubscriber(null));
    }

    // --- eventType ---

    @Test
    void eventTypeReturnsContentItemUnpublishedEventClass() {
    ...
    private static ContentItemUnpublishedEvent buildEvent() {
        return new ContentItemUnpublishedEvent(
