...
/**
 * Tests for {@link ContentItemUpdatedCacheInvalidationSubscriber}.
 */
class ContentItemUpdatedCacheInvalidationSubscriberTest {
    ...
    private ContentItemUpdatedCacheInvalidationSubscriber subscriber;

    @BeforeEach
    void setUp() {
        cache = new ConcurrentMapCacheRegion<>();
        subscriber = new ContentItemUpdatedCacheInvalidationSubscriber(cache);
    }
    ...
    void constructorRejectsNullCache() {
        assertThrows(NullPointerException.class,
                () -> new ContentItemUpdatedCacheInvalidationSubscriber(null));
    }

    // --- eventType ---

    @Test
    void eventTypeReturnsContentItemUpdatedEventClass() {
    ...
    private static ContentItemUpdatedEvent buildEvent() {
        return new ContentItemUpdatedEvent(
