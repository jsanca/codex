...
/**
 * Tests for {@link ContentItemPublishedCacheInvalidationSubscriber}.
 */
class ContentItemPublishedCacheInvalidationSubscriberTest {
    ...
    private ContentItemPublishedCacheInvalidationSubscriber subscriber;

    @BeforeEach
    void setUp() {
        cache = new ConcurrentMapCacheRegion<>();
        subscriber = new ContentItemPublishedCacheInvalidationSubscriber(cache);
    }
    ...
    void constructorRejectsNullCache() {
        assertThrows(NullPointerException.class,
                () -> new ContentItemPublishedCacheInvalidationSubscriber(null));
    }
    ...
    private static ContentItemPublishedEvent buildEvent() {
