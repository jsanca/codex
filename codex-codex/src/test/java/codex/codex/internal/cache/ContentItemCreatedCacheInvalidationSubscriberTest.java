...
/**
 * Tests for {@link ContentItemCreatedCacheInvalidationSubscriber}.
 */
class ContentItemCreatedCacheInvalidationSubscriberTest {
    ...
    private ContentItemCreatedCacheInvalidationSubscriber subscriber;

    @BeforeEach
    void setUp() {
        cache = new ConcurrentMapCacheRegion<>();
        subscriber = new ContentItemCreatedCacheInvalidationSubscriber(cache);
    }
    ...
    void constructorRejectsNullCache() {
        assertThrows(NullPointerException.class,
                () -> new ContentItemCreatedCacheInvalidationSubscriber(null));
    }

    // --- eventType ---

    @Test
    void eventTypeReturnsContentItemCreatedEventClass() {
    ...
    private static ContentItemCreatedEvent buildEvent() {
        return new ContentItemCreatedEvent(
