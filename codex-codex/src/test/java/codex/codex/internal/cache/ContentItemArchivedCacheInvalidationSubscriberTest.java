...
/**
 * Tests for {@link ContentItemArchivedCacheInvalidationSubscriber}.
 */
class ContentItemArchivedCacheInvalidationSubscriberTest {
    ...
    private ContentItemArchivedCacheInvalidationSubscriber subscriber;

    @BeforeEach
    void setUp() {
        cache = new ConcurrentMapCacheRegion<>();
        subscriber = new ContentItemArchivedCacheInvalidationSubscriber(cache);
    }
    ...
    void constructorRejectsNullCache() {
        assertThrows(NullPointerException.class,
                () -> new ContentItemArchivedCacheInvalidationSubscriber(null));
    }

    // --- eventType ---

    @Test
    void eventTypeReturnsContentItemArchivedEventClass() {
    ...
    private static ContentItemArchivedEvent buildEvent() {
        return new ContentItemArchivedEvent(
