...
/**
 * Dispatched when a {@link codex.codex.api.model.entity.ContentItem} is unpublished,
 * reverting its status away from {@code PUBLISHED}.
 * <p>
 ...
 * @param siteKey              the site scope under which the item was unpublished
 ...
 * @param actor                the principal who triggered the unpublish
 * @param occurredAt           the instant at which the event occurred
 */
public record ContentItemUnpublishedEvent(
        ContentItemId id,
        SiteKey siteKey,
    ...
    public ContentItemUnpublishedEvent {
